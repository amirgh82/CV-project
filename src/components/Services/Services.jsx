                ...
                <div className="row">
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="service service-purple">
                            <svg xmlns="http://www.w3.org/2000/svg" width="69.016" height="64.973" viewBox="0 0 69.016 64.973">
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="service service-yellow">
                            ...
                            <h4 className='Service__title'>Interface Design</h4>
                            <p className="service__caption">Lipsum as it is sometimes known is dummy text used in laying out print, graphic or web designs.</p>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="service service-pink">
                            <svg xmlns="http://www.w3.org/2000/svg" width="78.997" height="65" viewBox="0 0 78.997 65">
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="service service-orange">
                            <svg xmlns="http://www.w3.org/2000/svg" width="72.977" height="64.991" viewBox="0 0 72.977 64.991">
                            ...
                            <h4 className='Service__title'>UX Design</h4>
                            <p className="service__caption">Lipsum as it is sometimes known is dummy text used in laying out print, graphic or web designs.</p>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="service service-blue">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64.99" height="64.99" viewBox="0 0 64.99 64.99">
                            ...
                            <h4 className='Service__title'>Motion Graphic</h4>
                            <p className="service__caption">Lipsum as it is sometimes known is dummy text used in laying out print, graphic or web designs.</p>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="service service-green">
                            ...
                            <h4 className='Service__title'>SEO Optimize</h4>
                            <p className="service__caption">Lipsum as it is sometimes known is dummy text used in laying out print, graphic or web designs.</p>
                        </div>
                    </div>
                </div>
