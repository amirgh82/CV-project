const resumeData = [
    {
        id: 1, title: 'Education', secondTitle: ' University', subTitile: ' Engineer', des: 'Lorem ipsum dolor sit amet, consectetur debitis ipsa!', svg: <svg className='resume-list__icon' xmlns="http://www.w3.org/2000/svg" width="22" height="21.999" viewBox="0 0 22 21.999">
    ...
    {
        id: 2, title: 'Work History', secondTitle: 'Envato ', subTitile: 'B.sc in complater ', des: '. Modi doloremque quisquam ipsam est! Nobis consectetur delectus sunt unde, debitis ipsa!', svg: <svg className='resume-list__icon' xmlns="http://www.w3.org/2000/svg" width="22" height="21.999" viewBox="0 0 22 21.999">
    ...
    {
        id: 3, title: 'Programming Skill', secondTitle: 'Envato University Programming', subTitile: 'BBC profiler', des: 'Lorem ipsum dolor sit amet,  doloremque quisquam ipsam est! Nobis consectetur delectus sunt unde, debitis ipsa!', svg: <svg className='resume-list__icon' xmlns="http://www.w3.org/2000/svg" width="24.126" height="19.301" viewBox="0 0 24.126 19.301">
    ...
    {
        id: 4, title: 'Designer Skills', secondTitle: 'Envato University', subTitile: 'B.sc in complater Engineer', des: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi doloremque quisquam ipsam est! Nobis consectetur delectus sunt unde, debitis ipsa!', svg: <svg className='resume-list__icon' xmlns="http://www.w3.org/2000/svg" width="23.303" height="18.448" viewBox="0 0 23.303 18.448">
    ...
    {
        id: 5, title: 'SEO Skills', secondTitle: 'Envato University', subTitile: 'B.sc in complater Engineer', des: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi doloremque quisquam ipsam est! Nobis consectetur delectus sunt unde, debitis ipsa!', svg: <svg className='resume-list__icon' xmlns="http://www.w3.org/2000/svg" width="18.888" height="14.167" viewBox="0 0 18.888 14.167">
...
export const swiperData = [
    ...
    { id: 2, title: 'Illustration', img: ['/images/portfolio-1.jpg', '/images/portfolio-3.jpg' , '/images/portfolio-1.jpg', '/images/portfolio-3.jpg'] },
